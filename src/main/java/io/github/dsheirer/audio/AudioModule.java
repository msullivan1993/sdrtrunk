    ...
    Listener<float[]>
{
     ...
     */
    public AudioModule(AliasList aliasList, int timeslot, long maxAudioSegmentLength, boolean audioFilterEnable, boolean requireAliasMatch, int squelchDelayTimeMs, boolean squelchDelayRemoveSilence)
    {
